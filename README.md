...
- It uses strict filtering algorithm on the 48-hour window fetched news articles
- Then filter duplicated news from there because same news from different sources are collected very often.
